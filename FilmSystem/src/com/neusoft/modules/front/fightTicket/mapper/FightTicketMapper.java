package com.neusoft.modules.front.fightTicket.mapper;
...
public interface FightTicketMapper extends CommonInterface<FightTicket>{
	 ...
	 * 查找拼单信息 根据发布的时间排序 
	 */
	public List<FightTicket> selFightByCreateDate(FightTicket fightTicket);
	 ...
	 * 查询所有订单
	 */
	public List<FightTicket> selAllByAdmin(FightTicket fightTicket);
