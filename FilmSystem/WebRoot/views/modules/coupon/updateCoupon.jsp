        	...
        	<table>
        		<tr style="margin-top:10px;">
        			...
        			<td>
        				...
        				<input class="input input-mid" type="text" name="couponName" value="${coupon.couponName }">
        			</td>
        		</tr>
        		<tr style="margin-top:10px;">
        			<td>优惠价格：</td>
        			<td>
        				<input type="number" class="input input-mid"  name="couponPrice" onblur="checkPrice(this)" value="${coupon.couponPrice }">
        			</td>
        		</tr>
        		<tr style="margin-top:10px;">
        			<td>类型：</td>
        		...
        		<tr>
        			<td>影片：</td>
        			<td>
        				<select class="input input-mid" id="filmId" name="filmDetail.id">
...
<script type="text/javascript">
	...
	$(function(){
		...
		var filmId = '${coupon.filmDetail.id}';
		console.log(filmId);
